...
**NOTE**
This maintenance of this library has moved over to [Carcraftz](https://github.com/graph-labs-io/fhttp). The only use for this repository is so imports will not break.
...
```go
import (
    http "github.com/graph-labs-io/fhttp"
)
```
